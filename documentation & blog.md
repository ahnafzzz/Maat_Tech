SO THIS is the first ever documentetion for me
the website i'm building is for a ecommerce startup name: maat technologies bd
i have planned to create a Laravel dynamic website in a mechanical tech theme. 
with the help of Github Copilot i have finally managed to do that.
so first i made a homepage using claude
then i brought that code to the copilot and asked him to create me an admin page,login page and all the necessery pages that is required for this website
i think everything is done in somewhat ways
i belive the tech stack is 
...
why do i need the composer and php cli for?
